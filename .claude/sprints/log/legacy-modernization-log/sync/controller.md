...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-M`, `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-G4e`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-K`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-G3`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-G3-SSC`, `legacy-modernization-log/sync/snap.md`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-G4`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §9a`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8k-N`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8a-E6b`
