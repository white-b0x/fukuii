...
- **Cross-refs:** `consensus/engine.md §NAMING-MICRO` for full entry; `.claude/sprints/archive/DEFERRED-BACKLOG.md §NAMING-MICRO`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §ETH-T10-A`, `eth-sepolia-assumption-audit.md Thread 10`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §ETH-T10-B`, `eth-sepolia-assumption-audit.md Thread 10`
