...
- **Verify:** 16/16 EngineApiSpec ✅. `grep -n "\breturn\b" EngineApiController.scala` → 0 code-level hits. **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §8e-BEACON`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §NAMING-A`, `consensus/validators.md`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §NAMING-MICRO`, `§NAMING-INV` (audit that sourced the list), `api/jsonrpc.md`
...
- **Cross-refs:** `.claude/sprints/archive/DEFERRED-BACKLOG.md §7f`, `sync/controller.md §8k-N`
